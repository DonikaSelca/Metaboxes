<?php
  function practice-theme-1_add_meta_box(){
    add_meta_box(
      ...
      esc_html__( 'Post Settings', 'practice-theme-1-metaboxes'),
...
?>
  <p>
    <label for="practice-theme-1_post_metabox_html"><?php esc_html_e('Subtitle', 'practice-theme-1-metaboxes');?></label>
    <br/>
  ...
  <p>
    <label for="practice-theme-1_post_layout_field"><?php esc_html_e( 'Layout', 'practice-theme-1-metaboxes');?></label>
    <select name="practice-theme-1_post_layout_field" id="practice-theme-1_post_layout_field" class="widefat">
      <option <?php selected( $layout, 'full');?> value="full"><?php esc_html_e( 'Full Width', 'practice-theme-1-metaboxes');?></option>
      <option <?php selected( $layout, 'sidebar');?> value="sidebar"><?php esc_html_e( 'Post With Sidebar', 'practice-theme-1-metaboxes');?></option>
    </select>
  </p>
<?php
  }
